...
namespace Microsoft.Azure.Documents.ChangeFeedProcessor.PartitionManagement
{
    ...
    internal class RemainingWorkEstimator : IRemainingWorkEstimator
    {
        ...
        private readonly DocumentClient feedDocumentClient;
        ...
        public RemainingWorkEstimator(
            ...
            DocumentClient feedDocumentClient,
        ...
        private async Task<long> GetRemainingWorkAsync(ILease existingLease)
        {
            ...
            IDocumentQuery<Document> query = this.feedDocumentClient.CreateDocumentChangeFeedQuery(this.collectionSelfLink, options);
