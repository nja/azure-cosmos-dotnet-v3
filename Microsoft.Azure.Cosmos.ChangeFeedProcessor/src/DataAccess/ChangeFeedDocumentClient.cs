...
namespace Microsoft.Azure.Documents.ChangeFeedProcessor.DataAccess
{
    ...
    {
        private readonly CosmosClient documentClient;

        /// <summary>
        /// Initializes a new instance of the <see cref="ChangeFeedDocumentClient"/> class.
        /// </summary>
        /// <param name="documentClient">Existing <see cref="CosmosClient"/>.</param>
        public ChangeFeedDocumentClient(CosmosClient documentClient)
        {
